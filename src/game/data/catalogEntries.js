...
export const VOID_CREATURE_CATALOG = [
  createVoidEntry(0, '裂隙侍者', 'rift-servitor', 0x6ef3ff, '裂口拟态，短促突进。'),
  createVoidEntry(1, '空壳朝圣者', 'hollow-pilgrim', 0xffc86e, '空心重躯，缓慢牵引。'),
  createVoidEntry(2, '盲目注视体', 'blind-gazer', 0xc78bff, '闭眼漂浮，远程压制。'),
  createVoidEntry(3, '折叠猎犬', 'fold-hound', 0x8fffba, '折骨奔袭，侧翼扑杀。'),
  createVoidEntry(4, '回声寄生体', 'echo-parasite', 0xff8fb7, '复制轮廓，延迟回响。'),
  createVoidEntry(5, '虚空编钟', 'void-bell', 0x82a7ff, '悬浮重器，改写区域规则。'),
]
